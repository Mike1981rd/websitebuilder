    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "RoomTypes",
                columns: new[] { "Id", "BasePrice", "CreatedAt", "Description", "MaxOccupancy", "Name", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, 50.00m, new DateTime(2025, 6, 5, 15, 2, 13, 575, DateTimeKind.Utc).AddTicks(7996), "Habitación individual estándar", 1, "Individual", null },
                    { 2, 80.00m, new DateTime(2025, 6, 5, 15, 2, 13, 575, DateTimeKind.Utc).AddTicks(8008), "Habitación doble estándar", 2, "Doble", null },
                    { 3, 150.00m, new DateTime(2025, 6, 5, 15, 2, 13, 575, DateTimeKind.Utc).AddTicks(8010), "Suite de lujo", 4, "Suite", null },
                    { 4, 300.00m, new DateTime(2025, 6, 5, 15, 2, 13, 575, DateTimeKind.Utc).AddTicks(8013), "Suite presidencial de lujo", 6, "Suite Presidencial", null }
                });
